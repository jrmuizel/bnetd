...
#define CLIENT_COUNTRYINFO_109_VERSIONID           0x00000009
...
{
    t_bnet_header h;
    bn_int        type; /* type of request */
    bn_int        unknown2; /* 00 00 00 00 */
    /* file */
} t_client_tosreq PACKED_ATTR();
#define CLIENT_TOSREQ_TOSFILE      0x0000001a /* tos_USA.txt */
#define CLIENT_TOSREQ_GATEWAYS     0x0000001b /* STAR bnserver.ini */
#define CLIENT_TOSREQ_GATEWAYS_D2  0x80000004 /* D2XP bnserver-D2DV.ini */
#define CLIENT_TOSREQ_ICONS        0x0000001d /* STAR icons_STAR.bni */
#define CLIENT_TOSREQ_UNKNOWN2     0x00000000 /* Always zero */
#define CLIENT_TOSREQ_FILETOSUSA   "tos_USA.txt"
#define CLIENT_TOSREQ_FILETOSUNICODEUSA   "tos-unicode_USA.txt"
#define CLIENT_TOSREQ_FILEBNSERVER "bnserver.ini"
/******************************************************/
...
{
    t_bnet_header h;
    bn_int        type; /* type of req */
    bn_int        unknown2; /* 00 00 00 00 */ /* same as in TOSREQ */
    bn_long       timestamp; /* FIXME: file modification time? */
    /* file */
} t_server_tosreply PACKED_ATTR();
#define SERVER_TOSREPLY_TOSFILE      0x0000001a /* tos_USA.txt */
#define SERVER_TOSREPLY_GATEWAYS     0x0000001b /* STAR bnserver.ini */
#define SERVER_TOSREPLY_GATEWAYS_D2  0x80000004 /* D2XP bnserver-D2DV.ini */
#define SERVER_TOSREPLY_ICONS        0x0000001d /* STAR icons_STAR.bni */
#define SERVER_TOSREPLY_UNKNOWN2     0x00000000 /* always zero */
/******************************************************/
